...
export const eulaSections = [
  ...
  },
  {
    ...
    paragraphs: [
      "Aplikace je poskytována \u201Etak, jak je\u201C (as is), bez jakýchkoli výslovných či předpokládaných záruk, včetně záruky vhodnosti pro konkrétní účel, bezchybnosti nebo nepřerušeného provozu.",
      "Uživatel nese plnou odpovědnost za správnost přístupových údajů k serverům, konfiguraci přenosů a pravidelné zálohování svých dat. Poskytovatel neodpovídá za ztrátu, poškození nebo neúplný přenos dat, a to v maximálním rozsahu povoleném platnými právními předpisy.",
    ],
  },
  {
